...
class TransfuserConfig:
    ...
    bkb_path: str = "/media/clw/data/xdd/DiffusionDrive/accessory/pytorch_model.bin"
    plan_anchor_path: str = "/media/clw/data/xdd/DiffusionDrive/accessory/kmeans_navsim_traj_20.npy"
    ...
    # Std标准差 of the normal distribution initialization for linear layers in the GPT
    ...
    trajectory_cls_weight: float = 10
    trajectory_reg_weight: float = 4.2
    aux_reg_weight: float = 0.7
    diff_loss_weight: float = 12.0
