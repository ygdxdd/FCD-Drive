...
def plot_bev_with_agent(scene: Scene, agent: AbstractAgent) -> Tuple[plt.Figure, plt.Axes]:
    ...
    add_trajectory_to_bev_ax(ax, agent_trajectory[0], TRAJECTORY_CONFIG["agent"])
    add_trajectory_to_bev_ax(ax, agent_trajectory[1], TRAJECTORY_CONFIG["agent1"])
    add_trajectory_to_bev_ax(ax, agent_trajectory[2], TRAJECTORY_CONFIG["agent2"])
    #add_trajectory_to_bev_ax(ax, agent_trajectory[3], TRAJECTORY_CONFIG["agent3"])
    #add_trajectory_to_bev_ax(ax, agent_trajectory[4], TRAJECTORY_CONFIG["agent4"])
    configure_bev_ax(ax)
    configure_ax(ax)
